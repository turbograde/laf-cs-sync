...
QT_MOC_LITERAL(3, 14, 3), // "obj"
QT_MOC_LITERAL(4, 18, 7), // "deleted"
QT_MOC_LITERAL(5, 26, 12) // "emit_deleted"

    },
    "Card\0clicked\0\0obj\0deleted\0emit_deleted"
};
...
void Card::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clicked((*reinterpret_cast< QObject*(*)>(_a[1]))); break;
        case 1: _t->deleted((*reinterpret_cast< QObject*(*)>(_a[1]))); break;
        case 2: _t->emit_deleted(); break;
        default: ;
        }
        ...
        {
            typedef void (Card::*_t)(QObject * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Card::clicked)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Card::*_t)(QObject * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Card::deleted)) {
                *result = 1;
                return;
            }
        }
